...
font-size: large">
    ...
    margin: 17px 9px;
    padding: 13px 43px;
    box-shadow: 0px 0px 12px 2px #6c757d" type="text" class="form-control" id="name"
                               placeholder="Название дисциплины" required name="discName">
                    </div>
                </div>
                <div style="text-align: left;
                padding: 0 221px;
            ...
            border-radius: 12px;
            box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19);
            font-size: 16px;" type="submit" class="btn btn-outline-secondary btn btn-block">Создать
                        </button>
                    </div>
                </div>
            </form>
